...
%
\footnotetext{It is more common to sum \(C\) and 5 as income/output \(Y\). We prefer to argue from \(E\) for reasons shown in Appendix B, and to make the logic easier to follow. Economic dictionaries show a range of definitions for output. It is reasonably clear that the only sources of spending are pay and gross profit, while its only dispositions are in consumption and gross saving/investment.}
%
\begin{equation}
